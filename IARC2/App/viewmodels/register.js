...
D = {
    ...
    compositionComplete: function () {
        ...
        D = document.getElementById("payment-progress-wrap"); document.getElementById("picbox"); var _ = document.getElementById("errormsg"); r = new ss.SimpleUpload({
            button: n,
            url: "/ws/uploadHandler.php?dir=img",
            name: "uploadfile",
            multiple: !1,
            ...
            startXHR: function () {
                var t = document.createElement("button"); i.appendChild(t),
