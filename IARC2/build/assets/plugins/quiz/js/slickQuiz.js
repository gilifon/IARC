...
(function($){
    $.slickQuiz = function(element, options) {
        var plugin   = this,
            ...
            defaults = {
                checkAnswerText:  'בדוק את התשובה',
                nextQuestionText: 'הבא &raquo;',
                backButtonText: '',
                tryAgainText: '',
            ...
            setupQuiz: function() {
                ...
                for (i in questions) {
                    if (questions.hasOwnProperty(i)) {
                        ...
                        questionHTML.append('<div class="' + questionCountClass + '">שאלה מספר <span class="current">' + count + '</span> מתוך <span class="total">' + questionCount + '</span></div>');
