define(['plugins/router', 'durandal/app', 'services/cachingService', 'services/utilities', 'services/displayService'],
    function (router, app, cachingService, utilities, displayService) {
