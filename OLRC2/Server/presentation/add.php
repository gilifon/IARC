...
if (include '../isauthorized.php')
{
    ...
    $body = 'A presentation has been added to the online course website (NOT attached here):<br/>'.$newpresentation['d'].'<br/> Please visite the online course<br/> http://iarc.org/lessons/#home';
    mail($to,'A presentation has been added',$body,$headers);
    ###########################################################################################################
