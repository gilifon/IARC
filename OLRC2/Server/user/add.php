...
if (include '../isauthorized.php')
{
    ...
    $message .= "שלום,<br/>";
    $message .= "להלן הפרטים לכניסה לקורס חובבי הרדיו המתוקשב:<br/><br/>";
    $message .= '<table style="max-width: 100%; background-color: transparent; border-collapse: collapse; border-spacing: 0; margin-bottom: 20px; background-color: #ffffff;">';
    ...
    $message .= "<td style='-webkit-border-bottom-right-radius: 4px; border-bottom-right-radius: 4px; -moz-border-radius-bottomright: 4px; text-align:left; direction:ltr'>http://www.iarc.org/lessons/</td>";
    $message .= "</tr>";
    $message .= "</table>";
    $message .= "</body>";
    $message .= "</html>";
